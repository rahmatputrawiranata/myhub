...
<title>@yield('title') | RemoteHUB Indonesia</title>
...
{{-- <link href="{{ asset('bower_components/admin-md/plugins/materialize-css/css/materialize.css')}}" type="text/css" rel="stylesheet" media="screen,projection"/> --}}
