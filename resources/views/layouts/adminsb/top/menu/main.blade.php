...
<a href="{{ url('market/home')}}" class="btn bg-cyan waves-effect" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="MarketHUB">
    <i class="material-icons">touch_app</i>
</a>
<a href="{{ url('jobs/home')}}" class="btn bg-cyan waves-effect" data-toggle="tooltip" data-placement="bottom" title="" data-original-title="CareerHUB">
