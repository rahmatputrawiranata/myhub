<nav class="navbar navbar-default navbar-fixed navbar-transparent dark bootsnav">
    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{{ url('/')}}">
                <img src="{{ asset('img/cloud-white.png')}}" class="logo logo-display" alt="">
                <img src="{{ asset('img/cloud-logo.png')}}" class="logo logo-scrolled" alt="">
            </a> 
        </div>
    ...
    <div class="side light-bg">
        ...
        <div class="widget">
            <p class="text-center text-white my-3"> <a href="{{ url('/') }}"><img src="{{ asset('templates/kkr021/img/cloud-white.png')}}" class="logo" alt="" /><br><h3>Remote<b>Hub</b>  <small>.id</small></h3></a></p>
