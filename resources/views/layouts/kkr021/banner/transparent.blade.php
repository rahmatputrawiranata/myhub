...
<section class="full-height fullscreen bg white-text header-slide">
                  <div class="owl-carousel owl-theme light-arrow" data-items="1" data-md-items="1" data-sm-items="1" data-nav-dots="false" data-nav-arrow="true" data-auto-play="false"  data-space="0">
                     <!-- item -->
                     <div class="item"  >
                        <div class="slide-img"><img src="{{ asset('templates/kkr021/img/consultant/slide3.jpg')}}" alt="" /></div>
                        <div class="container">
                           <div class="row">
                              <div class="col-md-8">
                     ...
                     <!-- item -->
                     <div class="item" >
                        <div class="slide-img"><img src="{{ asset('templates/kkr021/img/consultant/slide2.jpg')}}" alt="" /></div>
                        <div class="container">
                           <div class="row">
                     ...
                     <!-- item -->
                     <div class="item"  >
                        <div class="slide-img"><img src="{{ asset('templates/kkr021/img/consultant/slide1.jpg')}}" alt="" /></div>
                        <div class="container">
                           <div class="row">
                              <div class="col-md-8">
                                 <h3 class="title">RemoteHub.id</h3>
