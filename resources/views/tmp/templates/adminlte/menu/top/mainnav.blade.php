...
<ul class="nav navbar-nav">
  ...
  {{-- @include('layouts.adminlte.menu.top.remotehub') --}}
  {{-- @include('layouts.adminlte.menu.top.jobshub') --}}
  {{-- @include('layouts.adminlte.menu.top.learninghub') --}}
  {{-- @include('layouts.adminlte.menu.top.markethub') --}}
