  <ul class="nav navbar-nav">
    ...
    <!-- messages -->
    {{-- @include('layouts.adminlte.menu.top.messages') --}}
    <!-- Notifications: style can be found in dropdown.less -->
    <!-- notif -->
    {{-- @include('layouts.adminlte.menu.top.notif') --}}
    
    <!-- Tasks: style can be found in dropdown.less -->
    
    <!-- tasks -->
    {{-- @include('layouts.adminlte.menu.top.tasks') --}}
    <!-- end task item -->
        ...
        <ul class="dropdown-menu">
          ...
          <li class="user-header">
            ...
            <p>
              ...
              @include('layouts.adminlte.menu.top.myhub')
              <!-- Menu Body -->
              <li class="user-body">
