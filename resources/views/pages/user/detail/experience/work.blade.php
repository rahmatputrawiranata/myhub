    ...
    <div class="row clearfix">
        <div class="col-sm-12">
            <select name="industry" id="position-industry" class="">  
                ...
                <option value="138">Business Supplies &amp; Equipment</option>
                ...
                <option value="101">Fundraising</option>
                ...
                <option value="124">Health, Wellness &amp; Fitness</option>
                ...
                <option value="134">Import &amp; Export</option>
                ...
                <option value="96">Information Technology &amp; Services</option>
                <option value="42">Insurance</option>
                <option value="74">International Affairs</option>
                <option value="141">International Trade &amp; Development</option>
                ...
                <option value="116">Logistics &amp; Supply Chain</option>
                ...
                <option value="35">Motion Pictures &amp; Film</option>
                <option value="37">Museums &amp; Institutions</option>
                ...
                <option value="146">Packaging &amp; Containers</option>
                ...
                <option value="98">Public Relations &amp; Communications</option>
                ...
                <option value="40">Recreational Facilities &amp; Services</option>
                ...
                <option value="108">Translation &amp; Localization</option>
                ...
                <option value="142">Wine &amp; Spirits</option>
                <option value="119">Wireless</option>
                <option value="103">Writing &amp; Editing</option>
            </select>
        </div>
    </div>
    <div class="row clearfix">
