        ...
        <div class="body">
            <div class="form-line">
                <div class="form-group">
                    ...
                    <div class="form-line">
                        <textarea rows="2" class="form-control no-resize" placeholder="Start type what you think..."></textarea>
                ...
                <small><a href="#">Write article</a> in blog</small>
            </div>
        </div>
    </div>
    </div>
        ...
        <div class="panel-body">
            <div class="post">
                ...
                <div class="post-content">
                    <img src="{{ asset('img/events/zata.jpg')}}" class="img-responsive" />
                </div>
            </div>
        </div>
    ...
    <div class="panel panel-default panel-post">
        ...
        <div class="panel-body">
            <div class="post">
                ...
                <div class="post-content">
                    <iframe width="100%" height="360" src="https://www.youtube.com/embed/b2ow44cQmxI" frameborder="0" allowfullscreen=""></iframe>
                </div>
            </div>
        </div>
        <div class="panel-footer">
