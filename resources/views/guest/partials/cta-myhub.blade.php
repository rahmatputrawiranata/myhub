         ...
         <div class="col-lg-4 col-md-6 theme-bg" >
            <div class="pxy-5 xs-px-3 xs-py-3 text-white pos-r">
               <div class="heading-block">
                  <h2 class="solid-weight">MyHUB</h2>
               ...
               <a href="myhub" class="btn btn-flat btn-default btn-outline white-border white-text fill-white">view all</a> 
            </div>
         </div>
                  ...
                  <div class="col-sm-4 col-xs-6 col-xx-12">
                     <div class="team classes">
                        ...
                        <div class="team-info">
                           ...
                           <div class="social"> The guiding goal of our Community Creativity initiative is to make art a central element of problem solving on more issues, across more sectors and in more ... </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-sm-4 col-xs-6 col-xx-12">
                     <div class="team classes">
                        ...
                        <div class="team-info">
                           ...
                           <div class="social"> E.R.P Channel infuses Latin rhythms with cardiovascular exercise to create an aerobic routine that is fun </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-sm-4 col-xs-6 col-xx-12">
                     <div class="team classes">
                        ...
                        <div class="team-info">
                           ...
                           <div class="social"> MMA fighters are among the fittest Developer in the world, and you’ll be just as strong  with our mixed martial arts </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-sm-4 col-xs-6 col-xx-12">
                     <div class="team classes">
                        ...
                        <div class="team-info">
                           ...
                           <div class="social"> Learn proper Networking techniques with Sam Oconal Learn proper aerobic techniques with Sam Oconal </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-sm-4 col-xs-6 col-xx-12">
                     <div class="team classes">
                        ...
                        <div class="team-info">
                           ...
                           <div class="social"> Learn proper Marketing techniques with Sam Oconal Learn proper aerobic techniques with Sam Oconal </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-sm-4 col-xs-6 col-xx-12" id="events">
                     <div class="team classes">
                        ...
                        <div class="team-info">
                           ...
                           <div class="social"> Our Security program teaches gymnastics skills in a fun and safe environment. In addition </div>
                        </div>
                     </div>
                  </div>
               </div>
