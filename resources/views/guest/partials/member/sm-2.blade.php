<div class="owl-carousel clients-carousel" data-items="6" data-md-items="4" data-sm-items="3" data-xs-items="2" data-space="25">
  <div class="item">
    <div class="team">
      ...
      <div class="team-info">
        ...
        <p class="member-name">CEO/Founder</p>
        <div class="social">
  ...
  <div class="item">
    <div class="team">
      ...
      <div class="team-info">
        ...
        <p class="member-name">Sales Assistance</p>
        <div class="social">
          <a href="#"><i class="fa fa-facebook"></i></a>
          <a href="#"><i class="fa fa-twitter"></i></a>
          <a href="#"><i class="fa fa-linkedin"></i></a>
  ...
  <div class="item">
    <div class="team">
      ...
      <div class="team-info">
        ...
        <p class="member-name">Art Director</p>
        <div class="social">
          <a href="#"><i class="fa fa-facebook"></i></a>
          <a href="#"><i class="fa fa-twitter"></i></a>
          <a href="#"><i class="fa fa-linkedin"></i></a>
  ...
  <div class="item">
    <div class="team">
      ...
      <div class="team-info">
        ...
        <p class="member-name">Developer</p>
        <div class="social">
          <a href="#"><i class="fa fa-facebook"></i></a>
          <a href="#"><i class="fa fa-twitter"></i></a>
          <a href="#"><i class="fa fa-linkedin"></i></a>
