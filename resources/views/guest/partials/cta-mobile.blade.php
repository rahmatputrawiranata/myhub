   ...
   <div class="container-fluid grey-bg">
      <div class="row">
         <div class="col-md-7 col-sm-6">
            ...
            <a href="#" class="btn btn-default btn-outline hover-effect3 btn-sm">PLAY STORE <i class="fa fa-play" aria-hidden="true"></i></a>
            <a href="#" class="btn btn-sm btn-default dark-bg hover-effect3">APP STORE <i class="fa fa-apple" aria-hidden="true"></i></a>
         </div>
         <div class="col-md-5 col-sm-6  dark-bg">
            ...
            <div class="timeline timeline-3 clearfix mt-4">
               <div class="timeline-panel">
                  <label class="year theme-bg">03.JAN</label>
               ...
               <div class="timeline-panel">
                  <label class="year theme-bg">10.JAN</label>
                  <div class="timeline-body">
               ...
               <div class="timeline-panel">
                  <label class="year theme-bg">17.JAN</label>
                  <div class="timeline-body">
