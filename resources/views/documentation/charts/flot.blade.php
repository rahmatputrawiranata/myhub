            ...
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                ...
                <div class="btn-group" id="realtime" data-toggle="btn-toggle">
                  <button type="button" class="btn btn-flat btn-default btn-xs active" data-toggle="on">On</button>
                  <button type="button" class="btn btn-flat btn-default btn-xs" data-toggle="off">Off</button>
                </div>
              </div>
            </div>
            <div class="box-body">
  ...
  $(function () {
    ...
    $('#line-chart').bind('plothover', function (event, pos, item) {
      ...
      if (item) {
        ...
        $('#line-chart-tooltip')(item.series.label + ' of ' + x + ' = ' + y)
