          ...
          <div class="box box-primary direct-chat direct-chat-primary">
            <div class="box-header with-border">
              ...
              <div class="box-tools pull-right">
                ...
                <button type="button" class="btn btn-flat btn-box-tool" data-toggle="tooltip" title="Contacts" data-widget="chat-pane-toggle">
            ...
            <div class="box-footer">
              <form action="#" method="post">
                <div class="input-group">
                  <input type="text" name="message" placeholder="Type Message ..." class="form-control">
                      <span class="input-group-btn">
                        <button type="submit" class="btn btn-flat btn-success btn-flat">Send</button>
                      </span>
                </div>
              </form>
            </div>
            ...
            <div class="box-footer">
              <form action="#" method="post">
                <div class="input-group">
                  <input type="text" name="message" placeholder="Type Message ..." class="form-control">
                      <span class="input-group-btn">
                        <button type="submit" class="btn btn-flat btn-warning btn-flat">Send</button>
                      </span>
                </div>
              </form>
            </div>
            ...
            <div class="box-footer">
              <form action="#" method="post">
                <div class="input-group">
                  <input type="text" name="message" placeholder="Type Message ..." class="form-control">
                      <span class="input-group-btn">
                        <button type="submit" class="btn btn-flat btn-danger btn-flat">Send</button>
                      </span>
                </div>
              </form>
            </div>
        ...
        <div class="col-md-6">
          ...
          <div class="box box-widget">
            <div class="box-header with-border">
              ...
              <!-- /.user-block -->
              <div class="box-tools">
                <button type="button" class="btn btn-flat btn-box-tool" data-toggle="tooltip" title="Mark as read">
