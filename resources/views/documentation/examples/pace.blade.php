      ...
      <div class="box">
        <div class="box-header with-border">
          ...
          <div class="box-tools pull-right">
            <button type="button" class="btn btn-flat btn-box-tool" data-widget="collapse" data-toggle="tooltip"
                    title="Collapse">
        ...
        <div class="box-body">
          ...
          <div class="row">
            <div class="col-xs-12 text-center">
              <button type="button" class="btn btn-flat btn-default btn-lrg ajax" title="Ajax Request">
