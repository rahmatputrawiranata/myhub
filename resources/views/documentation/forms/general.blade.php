            ...
            <div class="box-body">
              ...
              <div class="input-group input-group-lg">
                <div class="input-group-btn">
                  <button type="button" class="btn btn-flat btn-warning dropdown-toggle" data-toggle="dropdown">Action
          ...
          <div class="box box-info">
            ...
            <form class="form-horizontal">
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-flat btn-info pull-right">Sign in</button>
              </div>
              <!-- /.box-footer -->
            </form>
          </div>
