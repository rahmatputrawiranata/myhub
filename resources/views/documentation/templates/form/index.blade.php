...
@section('extra-script')
	{{Html::script('bower_components/admin-md/plugins/autosize/autosize.js')}}
	{{Html::script('bower_components/admin-md/plugins/momentjs/moment.js')}}
	{{Html::script('bsdmd/plugins/bootstrap-material-datetimepicker/js/bootstrap-material-datetimepicker.js')}}
	{{Html::script('bower_components/admin-md/js/pages/forms/basic-form-elements.js')}}
@endsection