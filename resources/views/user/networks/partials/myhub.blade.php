<div class="row">
  <div class="col-md-6">
    ...
    <div class="box box-widget widget-user">
      ...
      <div class="widget-user-image">
        <img class="img-circle" src="{{ asset('img/icon/admin-icon.png')}}" alt="User Avatar">
      </div>
  ...
  <div class="col-md-6">
    ...
    <div class="box box-widget widget-user">
      <!-- Add the bg color to the header using any of the bg-* classes -->
      <div class="widget-user-header bg-black" style="background: url('{{ asset('img/photo3.jpg')}}') center center;">
