               ...
               <div class="row mb-3">
                  <div class="col-sm-6">
                     <div class="heading-block">
                        <i class="text-uppercase light-weight">Tempor incididunt labore dolore veniam</i>
                        <h3 class="text-uppercase solid-weight">Why Remote.MyHub.id </h3>
                     ...
                     <div class="row">
                        <div class="col-sm-4 mb-3">
                           <div class="feature">
                              ...
                              <div class="feature-info">
                                 <h5 class="solid-weight">Project Hub</h5>
                        ...
                        <div class="col-sm-4 mb-3">
                           <div class="feature">
                              ...
                              <div class="feature-info">
                                 <h5 class="solid-weight">My Hub</h5>
                                 <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the.</p>
                              </div>
                           </div>
                        </div>
                        <div class="col-sm-4 mb-3">
                           <div class="feature">
                              ...
                              <div class="feature-info">
                                 <h5 class="solid-weight">Family Hub</h5>
                                 <p>Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the.</p>
                              </div>
                           </div>
                        </div>
