    ...
    <div class="container">
        <div class="row">
            <div class="col-md-8 col-md-offset-2 text-center">
                ...
                <a href="#project" class="btn btn-default btn-outline white-border white-text fill-white">Project <strong class="text-primary">HUB</strong></a>&nbsp;&nbsp; 
                <a href="#myhub" class="btn btn-default animated theme-bg white-text">My <strong class="text-yellow">HUB</strong> <i class="fa fa-cubes" aria-hidden="true"></i></a> &nbsp;&nbsp; 
                <a href="member" class="btn btn-default btn-outline white-border white-text fill-white">Member <strong class="text-primary">HUB</strong class="text-primary"></a>
                </div>
            </div>
        </div>
    </section>
