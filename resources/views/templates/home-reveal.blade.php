...
<!--==========================
  ...
  <section id="intro">
    ...
    <div id="intro-carousel" class="owl-carousel" >
      <div class="item" style="background-image: url('{{ asset('reveal/img/intro-carousel/1.jpg')}}');"></div>
      <div class="item" style="background-image: url('{{ asset('reveal/img/intro-carousel/2.jpg')}}');"></div>
      <div class="item" style="background-image: url('{{ asset('reveal/img/intro-carousel/3.jpg')}}');"></div>
      <div class="item" style="background-image: url('{{ asset('reveal/img/intro-carousel/4.jpg')}}');"></div>
      <div class="item" style="background-image: url('{{ asset('reveal/img/intro-carousel/5.jpg')}}');"></div>
    </div>
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6 content">
              <h2>We Are Progressing Rapidly</h2>
                  ...
                  <div class="owl-carousel testimonials-carousel">
                    ...
                    <div class="testimonial-item">
                      <p>
                        ...
                        <img src="{{ asset('img/quote-sign-right.pn')}}g" class="quote-sign-right" alt="">
                      </p>
                  ...
                  <div class="container">
                    <div class="row">
                      ...
                      <div class="col-lg-3 cta-btn-container text-center">
                        ...
                        <a class="cta-btn align-middle" href="{{ url('login')}}">Talk to us</a>
                      </div>
                    </div>
