<nav class="navbar navbar-default navbar-sidebar bootsnav no-full">
    ...
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a class="navbar-brand mb-7" href="{{ url('/')}}"><img src="{{ asset('img/logo-5-dark.png')}}" class="logo logo-scrolled" alt=""> </a> 
        </div>
    ...
    <div class="side light-bg">
        ...
        <div class="widget">
            <p class="text-center text-white my-3">
                <a href="{{ url('/') }}"><img src="{{ asset('templates/kkr021/templates/kkr021/images/logo-5-white.png')}}" class="logo" alt="" /><br>Remote<b>Hub</b> Indonesia</a></p>
